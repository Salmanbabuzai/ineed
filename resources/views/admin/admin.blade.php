...
<div class="wrapper2 admin">

	<a href="{{ url('/adminManager') }}">
	<div class="card">
		<img src="/Images/getUserDetailsIcon.png">
		<h3 align="left">Manage User Details</h3>
		<br>
		<p>Currently you have Posts:</p>
		<h2 style="color: purple;">777
		</h2>
	</div>
	</a>

<a href="{{ url('/adminAllEmails') }}">
	<div class="card">
		<img src="/Images/getIcon.png">
		<h3 align="left">Get All User Emails</h3>
		<br>
		<p>Currently you have Posts:</p>
		<h2 style="color: purple;">777
		</h2>
...
<a href="{{ url('/adminAllPhones') }}">
	<div class="card">
		<img src="/Images/getUserPhoneIcon.png">
		<h3 align="left">Get All User Phone</h3>
		<br>
		<p>Currently you have Posts:</p>
		<h2 style="color: purple;">777
		</h2>
	...
	<div class="card">
		<img src="/Images/totalIcon.png">
		<h3 align="left">Total User Registered</h3>
		<br>
		<h2 style="color: purple; margin-left: 130px; font-size: 35px;">{{ $totalUsers }} 
		</h2>
	</div>
	...
	<div class="card">
		<img src="/Images/totalIcon.png">
		<h3 align="left">Total Posts Posted</h3>
		<br>
		<h2 style="color: purple; margin-left: 130px; font-size: 35px;">{{ $totalPosts }}
		</h2>
	</div>	
	...
	<div class="card">
		<img src="/Images/totalIcon.png">
		<h3 align="left">Total Offers Offered</h3>
		<br>
		<h2 style="color: purple; margin-left: 130px; font-size: 35px;">{{ $totalOffers }}
		</h2>
	</div>
	...
	<div class="big-card">
		...
		<img src="/Images/analytics.gif" style="width: 100%; height: 100%;">
...
<div class="loadmore"><a href="{{url('adminManager')}}">Load More>></a></div>
