     ...
     <a class="heading">Sign Up</a>
          ...
          <div class="top-row">
            <div class="field-wrap">
              <input type="text" name="fname" value="{{old('fname')}}" required="" placeholder="First Name*" autocomplete="off"/>
              <span style="color:red; font-size:15px;">@error('fname'){{$message}}@enderror</span>
            </div>
        
            <div class="field-wrap">
              <input type="text" name="lname" value="{{old('lname')}}" required="" placeholder="Last Name*" autocomplete="off"/>
          ...
          <div class="field-wrap">
            <input type="text" name="phone" value="{{old('phone')}}" placeholder="Phone*" required min="11" autocomplete="off"/>
